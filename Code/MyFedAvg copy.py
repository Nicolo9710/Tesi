...
def run(nrpc, j):
    ...
    class MyCalibrator(BaseEstimator, ClassifierMixin):
        def __init__(self, base_model, input_size, output_size, lr=0.2, epochs=20):
    ...
    def client_fn(cid: str, partition):
        ...
        model = MyCalibrator(base_model, input_size=15, output_size=15)
    ...
    calibrator = Calibrator(input_size=15, output_size=15)
    ...
    def start_clients_calibration(num_clients, partitions):
        def start_client_calibration(partition, node_id):
            ...
            fl.client.start_client(server_address="127.0.0.1:8079", client=client.to_client())
    ...
    base_model = model_federated
    final_model = MyCalibrator(base_model, input_size=15, output_size=15)
...
for k in num_rows:
    ...
    for i in range(10):
        ...
        #     if thread is not threading.current_thread():  # Avoid joining the main thread
        #         thread.join()
