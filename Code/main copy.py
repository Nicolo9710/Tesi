...
# train_x = pd.read_csv('C:/Users/lukyl/OneDrive/Desktop/dataset_tesi_CIC_IDS2017/MachineLearningCSV/MachineLearningCVE/a/X_train.csv')
# train_y = pd.read_csv('C:/Users/lukyl/OneDrive/Desktop/dataset_tesi_CIC_IDS2017/MachineLearningCSV/MachineLearningCVE/a/y_train.csv')
...
# idx_batch, net_cls_counts, data_ratio = __getDirichletData__(train_y_series.values, n_partitions, 0.6, 15)
...
#     client_x = client_x_df
#     client_y = client_y_df[' Label']
...
#     # file_path_valid = f"C:/Users/lukyl/OneDrive/Desktop/dataset_tesi_CIC_IDS2017/NF_ToN_IoT_V2/Dmatrix_algo_alpha_n/valid 1/1/valid_matrix{i}.bin"
#     file_path_valid = f"C:/Users/lukyl/OneDrive/Desktop/dataset_tesi_CIC_IDS2017/MachineLearningCSV/MachineLearningCVE/a/data/06/0/valid_matrix{i}.bin"
...
# file_path_valid = f"C:/Users/lukyl/OneDrive/Desktop/dataset_tesi_CIC_IDS2017/MachineLearningCSV/MachineLearningCVE/a/data/06/0/VALID_MATRIX.bin"
...
file_path_test = f"C:/Users/lukyl/OneDrive/Desktop/dataset_tesi_CIC_IDS2017/MachineLearningCSV/MachineLearningCVE/a/test_dmatrix.bin"
...
#     model_federated.load_model(f'C:\\Users\\lukyl\\OneDrive\\Desktop\\dataset_tesi_CIC_IDS2017\\MachineLearningCSV\\modelli\\{Alpha}\\model_federato{i}.json')
...
#     cl_federated = MyCalibrator(model_federated, input_size=15, output_size=15)
...
#     for i in tqdm(range(10)):
#         file_path_valid = f"C:/Users/lukyl/OneDrive/Desktop/dataset_tesi_CIC_IDS2017/MachineLearningCSV/MachineLearningCVE/a/data/{Alpha}/{i}/VALID_MATRIX.bin"
#         valid_server = xgb.DMatrix(file_path_valid)

#         model_federated_server = xgb.XGBClassifier()
#         model_federated_server.load_model(f'C:/Users/lukyl/OneDrive/Desktop/dataset_tesi_CIC_IDS2017/MachineLearningCSV/modelli/{Alpha}/model_federato{i}.json')
...
for row in num_rows:
    ...
    for i in tqdm(range(10)):
        ...
        model_federated_sklearn.load_model(f'C:/Users/lukyl/OneDrive/Desktop/dataset_tesi_CIC_IDS2017/MachineLearningCSV/modelli/{Alpha}/model_federato{i}.json')
...
#     file_path_valid = f"C:/Users/lukyl/OneDrive/Desktop/dataset_tesi_CIC_IDS2017/MachineLearningCSV/MachineLearningCVE/a/data/{Alpha}/{j}/valid_matrix{i}.bin"
...
#     cl_federated = MyCalibrator(model_federato, input_size=15, output_size=15)
#     cl_federated.fit(sampled_matrix.get_data(), sampled_matrix.get_label())
