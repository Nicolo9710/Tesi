...
class XgbClient(fl.client.Client):
    def __init__(self, partition, node_id):
        self.bst = None
        self.config = None
        self.train_dmatrix, self.valid_dmatrix, self.test_dmatrix, self.num_train, self.num_test = partition
    ...
    def fit(self, ins: FitIns) -> FitRes:
        if(self.iter < 5):
            ...
            x_train = self.valid_dmatrix.get_data()
            y_train = self.valid_dmatrix.get_label()
...
#altro metodo  tensorByteProto.tensor_content